class RegistrationsController < Devise::RegistrationsController
  ...
  def sign_up_params
    params.require(:user).permit(:name, :email, :phone, :password, :password_confirmation, :street_address_1, :street_address_2, :city, :state, :zipcode, :country, :preferred_contact, :expertise_description)
  end
